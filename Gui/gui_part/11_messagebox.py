import tkinter.messagebox as msgbox   # tkinter,messagebox 넣어주시고
from tkinter import*
...
def okcancel():  
    msgbox.askokcancel("확인 취소", "해당 좌석은 유아동반석입니다. 에매 하시겠습니까")
def retrycancel():
...
def yesnocancel():
    response = msgbox.askyesnocancel(title=None , message = "에매 내역이 저장되지 않았습니다.\n 저장 후 프로그램을 종료하시겠습니까?")    
    # 네 : 저장 후 종료
    # 아니오 : 저장 하지 않고 종료
    # 취소 : 프로그램 종료 취소 (현재화면에서 계속 작업)
    print("응답:", response)  #Truem False None -> 예 1, 아니오 0, 그 외
    if response == 1:
        print("예")
    elif response ==0:
        print("아니오")
